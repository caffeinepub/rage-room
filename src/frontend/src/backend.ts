...
export class Backend implements backendInterface {
    ...
    async getPremiumStatus(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getTopScores(): Promise<Array<RageRoomScore>> {
        if (this.processError) {
            try {
    ...
    async isPlayerPremium(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isPlayerPremium(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
